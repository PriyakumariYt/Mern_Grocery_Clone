...
const Contact = () => {
    ...
    if (userData && user) {
      ...
      const handleSubmit =async(e) => {
        ...
        try {
          const response = await fetch("https://grocery-backend-delta.vercel.app/api/form/contact", {
            method: "POST",
            headers: {
          ...
          <div className="section-registration">
            <div className="container-second">
              <div className="blur_img">
                <img
                  src="https://img.freepik.com/premium-photo/collection-vegetables-isolated-white-background-clipping-path_44074-8557.jpg?w=740"
